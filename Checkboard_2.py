...
print "Write a program that prints a 'checkerboard' pattern to the console."
#
...
# In our case we will alternate stars and spaces. The goal is to repeat a process
# several times. This should make you think of looping.
